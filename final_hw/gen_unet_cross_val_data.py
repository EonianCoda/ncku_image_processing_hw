...
if __name__ == '__main__':
    ...
    for fold_idx in range(1, num_fold + 1):
        input_root = './data/fold{}/'.format(fold_idx)
        mask_root = './data/yolov5/'
        output_root = './data/unet_fold{}/'.format(fold_idx)
        resize_size = (320, 320)

        img_size = (960, 960)
        weight_path = './yolov5/runs/train/960_bs16_med_E300_fold{}/weights/best.pt'.format(fold_idx)
        iou_thres = 0.6
        conf_thres = 0.1
